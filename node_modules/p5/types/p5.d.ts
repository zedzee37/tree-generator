...
/// <reference path="./accessibility/color_namer.d.ts" />
/// <reference path="./accessibility/describe.d.ts" />
/// <reference path="./accessibility/gridOutput.d.ts" />
/// <reference path="./accessibility/outputs.d.ts" />
/// <reference path="./accessibility/textOutput.d.ts" />
/// <reference path="./color/color_conversion.d.ts" />
/// <reference path="./color/creating_reading.d.ts" />
/// <reference path="./color/p5.Color.d.ts" />
/// <reference path="./color/setting.d.ts" />
/// <reference path="./core/constants.d.ts" />
/// <reference path="./core/environment.d.ts" />
/// <reference path="./core/friendly_errors/fes_core.d.ts" />
/// <reference path="./core/friendly_errors/file_errors.d.ts" />
/// <reference path="./core/friendly_errors/param_validator.d.ts" />
/// <reference path="./core/friendly_errors/stacktrace.d.ts" />
/// <reference path="./core/helpers.d.ts" />
/// <reference path="./core/legacy.d.ts" />
/// <reference path="./core/main.d.ts" />
/// <reference path="./core/p5.Graphics.d.ts" />
/// <reference path="./core/p5.Renderer.d.ts" />
/// <reference path="./core/reference.d.ts" />
/// <reference path="./core/rendering.d.ts" />
/// <reference path="./core/structure.d.ts" />
/// <reference path="./core/transform.d.ts" />
/// <reference path="./data/local_storage.d.ts" />
/// <reference path="./dom/dom.d.ts" />
/// <reference path="./dom/p5.Element.d.ts" />
/// <reference path="./dom/p5.File.d.ts" />
/// <reference path="./dom/p5.MediaElement.d.ts" />
/// <reference path="./events/acceleration.d.ts" />
/// <reference path="./events/keyboard.d.ts" />
/// <reference path="./events/pointer.d.ts" />
/// <reference path="./image/filterRenderer2D.d.ts" />
/// <reference path="./image/image.d.ts" />
/// <reference path="./image/loading_displaying.d.ts" />
/// <reference path="./image/p5.Image.d.ts" />
/// <reference path="./image/pixels.d.ts" />
/// <reference path="./io/files.d.ts" />
/// <reference path="./io/p5.Table.d.ts" />
/// <reference path="./io/p5.TableRow.d.ts" />
/// <reference path="./io/p5.XML.d.ts" />
/// <reference path="./math/Matrices/Matrix.d.ts" />
/// <reference path="./math/Matrices/MatrixNumjs.d.ts" />
/// <reference path="./math/calculation.d.ts" />
/// <reference path="./math/math.d.ts" />
/// <reference path="./math/noise.d.ts" />
/// <reference path="./math/p5.Matrix.d.ts" />
/// <reference path="./math/p5.Vector.d.ts" />
/// <reference path="./math/random.d.ts" />
/// <reference path="./math/trigonometry.d.ts" />
/// <reference path="./shape/2d_primitives.d.ts" />
/// <reference path="./shape/attributes.d.ts" />
/// <reference path="./shape/curves.d.ts" />
/// <reference path="./shape/custom_shapes.d.ts" />
/// <reference path="./shape/vertex.d.ts" />
/// <reference path="./type/p5.Font.d.ts" />
/// <reference path="./type/textCore.d.ts" />
/// <reference path="./utilities/conversion.d.ts" />
/// <reference path="./utilities/time_date.d.ts" />
/// <reference path="./utilities/utility_functions.d.ts" />
/// <reference path="./webgl/3d_primitives.d.ts" />
/// <reference path="./webgl/ShaderGenerator.d.ts" />
/// <reference path="./webgl/interaction.d.ts" />
/// <reference path="./webgl/light.d.ts" />
/// <reference path="./webgl/loading.d.ts" />
/// <reference path="./webgl/material.d.ts" />
/// <reference path="./webgl/p5.Camera.d.ts" />
/// <reference path="./webgl/p5.DataArray.d.ts" />
/// <reference path="./webgl/p5.Framebuffer.d.ts" />
/// <reference path="./webgl/p5.Geometry.d.ts" />
/// <reference path="./webgl/p5.Quat.d.ts" />
/// <reference path="./webgl/p5.RendererGL.d.ts" />
/// <reference path="./webgl/p5.Shader.d.ts" />
/// <reference path="./webgl/p5.Texture.d.ts" />
/// <reference path="./webgl/text.d.ts" />
...
has.
   */
  readonly WEBGL2: P5.WEBGL2;

  static ARROW: 'default';

  readonly SIMPLE: P5.SIMPLE;

  readonly FULL: P5.FULL;
...
radians equals 90˚, and `QUARTER_PI` radians equals 45˚.
   */
  readonly QUARTER_PI: P5.QUARTER_PI;
...
DEGREES.Note: `TWO_PI` radians equals 360˚.
   */
  readonly DEG_TO_RAD: P5.DEG_TO_RAD;
  ...
  static LINE_LOOP: any;

  static TRIANGLES: any;

  static TRIANGLE_FAN: any;

  static TRIANGLE_STRIP: any;

  static QUADS: 'quads';

  static QUAD_STRIP: 'quad_strip';

  static TESS: 'tess';

  static EMPTY_PATH: any;
...
be passed to the size function as AUTO, at a time.
  ...
  static DOWN_ARROW: 'ArrowDown';

  static ENTER: 'Enter';

  static ESCAPE: 'Escape';

  static LEFT_ARROW: 'ArrowLeft';

  static OPTION: 'Alt';

  static RETURN: 'Enter';

  static RIGHT_ARROW: 'ArrowRight';

  static SHIFT: 'Shift';

  static TAB: 'Tab';

  static UP_ARROW: 'ArrowUp';

  static BLEND: 'source-over';

  static REMOVE: 'destination-out';
  ...
  static POSTERIZE: 'posterize';

  static DILATE: 'dilate';
...
/**
 * A class to describe a shader program.Each `p5.Shader` object contains a shader program that runs on the graphics
 ...
 * language called
 * GLSL
 * and run along with the rest of the code in a sketch.A shader program consists of two files, a vertex shader and a fragment
 ...
 * function, as in `shader(myShader)`.A shader can optionally describe  which are functions in GLSL that
 ...
 * }
 * }`Then, in your vertex shader source, you can run a hook by calling a function
 * with the same name prefixed by `HOOK_`:`void main() {
 * HOOK_beforeVertex();
